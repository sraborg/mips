...
public class ITypeInstruction extends MipsInstruction {
	...
	public ITypeInstruction(String hexAddress, String hexInstruc, String binaryInstruction, String opcode) {
		...
		switch(opcode) {
			...
			case "001001":
				instruction = "addiu " + MipsSim.registerAlias(this.rt) + ", " + MipsSim.registerAlias(this.rs) + ", " + this.immediate;
				break;
			case "001000":
				instruction = "addi " + MipsSim.registerAlias(this.rt) + ", " + MipsSim.registerAlias(this.rs) + ", " + this.immediate;
				break;
			case "101011":
